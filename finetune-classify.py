...
system_prompt = (
    "You are an analyst specializing in logical reasoning and Yes/No/Uncertain classification."
...
training_args = SFTConfig(
    ...
    save_steps=100,  # Adjust based on trainings
    output_dir="./model/qwen-classify",
...
save_directory = "./model/qwen-classify"  # Choose your directory
